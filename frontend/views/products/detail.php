                        ...
                        <div class="col-12 order-lg-1 order-2 pt-10 pt-lg-0">
                            <div class="single-product-content">
                                ...
                                <ul class="quantity-with-btn pb-7">
                                    ...
                                    <a type="button" href="index.php?controller=cart&action=index" class="product-add btn btn-custom-size lg-size btn-primary btn-secondary-hover rounded-0" style="background: #f15b67; border-radius: 10px !important; border: 2px solid #fff;" onclick="addToCart(20, 98)" title="Add to Cart">
